...
public class StudentController {
    ...
    // @PostMapping("/buy-pages")
    // public ResponseEntity<ApiResponse> buyPages(@RequestBody PaymentLog payment,
    // @PathVariable String id) {
    // try {
    // studentService.buyPage(payment, id);
    // ApiResponse response = new ApiResponse(
    ...
    // ApiResponse response = new ApiResponse(
    // "success",
    // "File uploaded successfully and print log saved. File ID: " +
    // fileId.toString(),
    // printingLog);
    ...
    // "application/pdf").contains(contentType)) {
